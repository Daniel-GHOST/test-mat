...
describe('SimpsonComponent', () => {
  ...
  it('Should return 16 if f(x)=2x, x0=1 x1=4', ()=>{
    expect(component.calcular(1, 0, 4, 4, 0.00001)).toBeCloseTo(16.0,1);
  })

  it('Should return 0.333 if f(x)=x^2, x0=0 x1=1', ()=>{
    expect(component.calcular(2, 0, 1, 4, 0.0001)).toBeCloseTo(0.333,3);
  })

  it('Should return 1.38 in f(x)=1/x, x0=1, x1=4', ()=>{
    expect(component.calcular(3, 1, 4, 6, 0.001)).toBeCloseTo(1.386,3);
  })
});
